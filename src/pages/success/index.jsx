...
export default function Page() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="grid place-content-center rounded-full p-4 bg-green-300 w-14 h-14">
          <i className="ri-check-fill text-3xl font-bold text-green-600" />
        </div>
        <h1 className="font-bold text-xl">¡Pago completado!</h1>
